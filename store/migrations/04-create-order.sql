CREATE TABLE if not exists orders (
    ...
    order_id            INTEGER,
    execution           VARCHAR(20) NOT NULL CHECK (execution IN ('market', 'limit', 'stop_market', 'stop_limit')),
    ...
    status              VARCHAR(20) NOT NULL CHECK (status IN ('open', 'filled', 'partially_filled', 'canceled', 'draft')),
    partial             BOOLEAN,
